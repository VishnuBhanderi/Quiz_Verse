...
const adUnitId = __DEV__ ? TestIds.REWARDED : 'ca-app-pub-7528260341883951/5864051602';
const BannerAdUnitId = __DEV__ ? TestIds.BANNER : 'ca-app-pub-7528260341883951/9554232218';
...
export default function Quiz({navigation}) {
  ...
  const getQuiz = async () => {
    setIsLoading(true);
    const url =
      'https://opentdb.com/api.php?amount=10&category=15&difficulty=easy&type=multiple&encode=url3986';
